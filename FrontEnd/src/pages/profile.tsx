        ...
        <>
            ...
            <div className="flex overflow-hidden flex-col bg-white">
                <div className="flex flex-col items-start self-center mt-4 w-full max-w-[1400px] max-md:mt-10 max-md:max-w-full">
                    ...
                    <div className="flex flex-wrap gap-3 justify-between mt-8 max-w-full text-xl font-bold text-black w-[900px] max-md:mt-6">
                        <div>
                            Drinks:{' '}
                            <span className="">
                    ...
                    <div className="mt-10 w-full max-w-[1400px] max-md:mt-6 max-md:max-w-full">
                        <div className="flex gap-3 max-md:flex-col">
                            <div className="flex flex-col w-[30%] max-md:ml-0 max-md:w-full">
                                <div className="flex flex-col grow text-xl font-bold text-black max-md:mt-6 max-md:max-w-full">
                                    <div className="max-md:max-w-full">
                                        HEIGHT FROM:{' '}
                            ...
                            <div className="flex flex-col ml-3 w-[30%] max-md:ml-0 max-md:w-full">
                                <div className="text-xl font-bold text-black max-md:mt-6 max-md:max-w-full">
                                    HEIGHT TO:{' '}
                                    <span className="font-medium">
                    ...
                    <div className="mt-8 text-xl font-bold text-black max-md:mt-6 max-md:max-w-full">
