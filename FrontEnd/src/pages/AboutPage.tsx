...
const AboutPage = () => {
    return (
        <ErrorBoundary>
            ...
            <div>
                <div className="flex overflow-hidden flex-col items-center py-6 bg-white">
                    ...
                    <div className="mt-6 ml-4 w-full max-w-[1200px] max-md:mt-4 max-md:max-w-full">
                        <div className="flex gap-4 max-md:flex-col">
                            <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                                <div className="flex flex-col mt-20 max-md:mt-4 max-md:max-w-full">
                            ...
                            <div className="flex flex-col ml-2 w-6/12 max-md:ml-0 max-md:w-full">
                                <img
                                    loading="lazy"
                                    src={journey}
                                    className="object-contain grow w-full aspect-[1.05] shadow-lg max-md:mt-4 max-md:max-w-full"
                                />
                            </div>
                        </div>
                    </div>
                    <div className="mt-4 w-full max-w-[1200px] max-md:max-w-full">
                        <div className="flex gap-4 max-md:flex-col">
                            <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                                <div className="flex relative flex-col grow items-end px-8 pt-20 pb-4 min-h-[500px] shadow-lg max-md:pt-12 max-md:pl-2 max-md:max-w-full">
                                    <img
                                        loading="lazy"
                                        src={aboutus}
                ...
                <div className="flex flex-col justify-center items-center self-stretch px-10 py-10 mt-24 w-full bg-sky-200 max-md:px-4 max-md:mt-8 max-md:max-w-full">
